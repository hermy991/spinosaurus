...
Deno.test(testMessage.replace(/\{\}/ig, "insert execute() function should work"), async () => {
  ...
  let data = [{FirstName: "Hermy", UserName: "hermy991"}, {FirstName: "Yassett", UserName: "yassett77"}]
